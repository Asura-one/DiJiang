---
name: dj-tdd
description: "测试驱动开发：红绿重构循环，一次一个垂直切片。 Use when the user wants to build features or fix bugs test-first, mentions TDD, test-driven, red-green-refactor, or vertical slice. 触发词：TDD、测试驱动、红绿重构、先写测试。"
---
